...
import com.pmaptechnotech.iadas.interfaces.OnDateSetInterface;
...
public class P {
    ...
    public static String URL = "http://academic2018.pmapindia.com/intelligent_accident/index.php/";
    public static String IMAGE_URL = "http://academic2018.pmapindia.com/intelligent_accident/uploads/";
   ...
   /* //SET SPINNER ADAPTER
    ...
    public static void saveUserLoginData(Context context, User u) {
        ...
        editor.putString("user_address", u.user_address);
        editor.putString("user_blood_type", u.user_blood_type);
        editor.putString("user_image", u.user_image);
        editor.putString("user_username", u.user_username);
        editor.putBoolean("on_off", true);
        editor.apply();
    }

    public static void saveOnOff(Context context, boolean onOff) {
        SharedPreferences.Editor editor = context.getSharedPreferences(P.PREFS_LOGIN, Context.MODE_PRIVATE).edit();
        editor.putBoolean("on_off", onOff);
        editor.apply();
    }
    ...
    public static User getUserDetails(Context context) {
        ...
        u.user_address = prefs.getString("user_address", null);
        u.user_blood_type = prefs.getString("user_blood_type", null);
        u.user_image = prefs.getString("user_image", null);
        u.user_username = prefs.getString("user_username", null);
        u.on_off = prefs.getBoolean("on_off", true);
    ...
    public static void userLogout(Context context) {
        ...
        editor.putString("user_blood_type", null);
    ...
    public static double[] GetMinMaxLatLng(String lat_str, String lng_str) {
        ...
        if (lat_str != null && lng_str != null) {
            ...
            if (lat_str.trim().length() > 0 && lng_str.trim().length() > 0) {
                ...
                double deltaLat = C.PROXIMITY_RADIUS / 111.1;
                double deltaLong = C.PROXIMITY_RADIUS / kmInLongitudeDegree;

                double s1 = (values[0] = lat - deltaLat);
